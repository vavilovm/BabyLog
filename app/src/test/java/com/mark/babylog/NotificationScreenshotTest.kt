...
private fun Paparazzi.notificationPreview(backgroundColor: Int) {
    ...
    fun row(text: String, firstAction: String, secondAction: String, stopFirst: Boolean) =
        LayoutInflater.from(context)
            .inflate(R.layout.notification_timer_compact, null, false)
            .apply {
...
class NotificationLightScreenshotTest {
    ...
    @Test
    fun notificationRows_areLegibleWithoutOwnFill() =
        paparazzi.notificationPreview(Color.rgb(247, 242, 250))
}
...
class NotificationDarkScreenshotTest {
    ...
    @Test
    fun notificationRows_areLegibleWithoutOwnFill() =
        paparazzi.notificationPreview(Color.rgb(29, 27, 32))
}
